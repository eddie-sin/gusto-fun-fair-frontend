export const ORDER_STATUS: Record<string, { label: string; tone: 'waiting' | 'proof' | 'review' | 'good' | 'bad' | 'neutral'; message: string }> = {
  AWAITING_PAYMENT: { label: 'Waiting for payment', tone: 'waiting', message: 'Transfer by KBZ, write “fun fair” in the payment note, then submit your receipt.' },
  ...
  PAYMENT_APPROVED: { label: 'Ready to collect', tone: 'good', message: 'Payment approved. Show your order at the Coding Club counter to collect your food tokens.' },
